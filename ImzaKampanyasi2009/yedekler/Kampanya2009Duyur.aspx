    ...
    <tr>
        <td rowspan="2">
            <br />  <table style="width:100%">
                   <tr>
                       <td style="text-align: left; width: 50%; background-color: buttonface;" rowspan="2">
                   ...
                   <asp:TextBox ID="soyisim" runat="server"></asp:TextBox><br />
                   ...
                   <asp:TextBox ID="email" runat="server"></asp:TextBox><br />
                           ...
                           <asp:TextBox ID="MeslekTBox" runat="server" TextMode="MultiLine"></asp:TextBox><br />
                   <span style="font-size: 8pt; color: #000000;">
                        Þehir:</span><br />
                   ...
                   <br />
                       ...
                       görülebilecektir, internet sayfamýzda yayýnlanmayacaktýr):</span><br /> 
                           ...
                           <textarea id="MesajBox" runat="server" rows="10" cols="28" style="font-weight: bold"></textarea><br />
                           <strong>
                               <br />
                               &nbsp; </strong>
                       ...
                       <td rowspan="2" style="text-align: center; width:50%; background-color: buttonface;">

   

<table style="width:100%">
                   <tr>
                       <td colspan="2" style="text-align: left; width: 50%;" rowspan="3">             
                       ...
                       Gönderilecek Email Adresleri: </span>&nbsp;&nbsp;&nbsp;<br />
                           </span><span style="font-size: 8pt; color: #000000;">Birden fazla adrese göndermek için lütfen adresleri
                       &nbsp;noktalý virgül (;) &nbsp;veya virgül (,) ile ayýrarak yazýnýz.
                           <br />
                   </span>
                   ...
                   <textarea name="KampanyaDuyurMetni" id="Yorumlar" runat="server" rows="10" cols="28"  OnServerChange="Yorumlar_ServerChange"></textarea>                    <br />
                             <br />
                       &nbsp;<asp:Button ID="KampanyaGonderButton" runat="server" OnClick="KampanyaDuyur_Click"  Text="Kampanyayý Duyur" 
                       BackColor="DarkOrchid" ForeColor="White" />&nbsp;
                       </td></tr></table>
                   &nbsp;                                                 <br />
                           <br />
